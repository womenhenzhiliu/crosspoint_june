...
from models.dgcnn import DGCNN_partseg,pointnet_seg,pointnetplus
...
def train_seg(args, io):
    ...
    # model = pointnet_seg(args, seg_num_all,pretrain=False).to(device)
    ...
    for epoch in range(args.epochs):
        ...
        for data, label, seg in train_loader:
            ...
            # print('!!!!!seg_pred_shape!!!!:',seg_pred.shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='dgcnn_seg', metavar='N',
                        choices=[ 'dgcnn_seg', 'pointnetplus', 'pointnet'],
    ...
    parser.add_argument('--k1', type=int, default=40, metavar='N',
                        help='Num of nearest neighbors to use')
    parser.add_argument('--model_path', type=str, default='', metavar='N',
                        help='Pretrained model path')
    parser.add_argument('--pretrained_path', type=str, default='/home/june/PycharmProjects/CrossPoint_June1.0/checkpoints/crosspoint_dgcnn_seg/models/best_model.pth', metavar='N',
                    help='Pretrained model path')
